module.exports = {
  ...
  POMI_BOOKING_URL: process.env.POMI_BOOKING_URL || 'https://nhsukgpdataetl.blob.core.windows.net/etl-output/booking.json',
  POMI_SCRIPTS_URL: process.env.POMI_SCRIPTS_URL || 'https://nhsukgpdataetl.blob.core.windows.net/etl-output/scripts.json',
  POMI_RECORDS_URL: process.env.POMI_RECORDS_URL || 'https://nhsukgpdataetl.blob.core.windows.net/etl-output/records.json',
  OUTPUT_DIR: './data',
