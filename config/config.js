module.exports = {
  ...
  POMI_BOOKING_URL: process.env.POMI_BOOKING_URL || 'https://pomi-data-etl.dev.beta.nhschoices.net//json/booking.json',
  POMI_SCRIPTS_URL: process.env.POMI_SCRIPTS_URL || 'https://pomi-data-etl.dev.beta.nhschoices.net/json/scripts.json',
  POMI_RECORDS_URL: process.env.POMI_RECORDS_URL || 'https://pomi-data-etl.dev.beta.nhschoices.net/json/records.json',
  OUTPUT_DIR: './data',
